...
SOURCES		:=	src
DATA		:=	data
INCLUDES	:=	$(CURDIR)/include $(CURDIR)/src $(CURDIR)/opl $(CURDIR)/textscreen $(CURDIR)/src/main $(DEVKITPRO)/portlibs/3ds/include/SDL $(DEVKITPRO)/portlibs/3ds/include $(CTRULIB)/include
